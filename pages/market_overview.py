...
def create_market_overview_page(lang: str = 'zh-TW'):
    ...
    <style>
        ...
        .index-card:hover, .etf-card:hover {{
            border-color: var(--accent-primary);
            box-shadow: var(--glow-primary);
            transform: translateY(-2px);
        }}
        
        .index-header, .etf-header {{
            display: flex;
        ...
        .index-change, .etf-change {{
            font-size: 14px;
            font-weight: 500;
        }}
        
        .index-change.green, .etf-change.green {{
            color: var(--accent-success);
        }}
        
        .index-change.red, .etf-change.red {{
